...
func (r ApiCreateEventForJobAndRunRequest) Execute() (Event, *_nethttp.Response, error) {
 ...
 */
func (a *EventApiService) CreateEventForJobAndRun(ctx _context.Context, jobId string, runId string) ApiCreateEventForJobAndRunRequest {
	return ApiCreateEventForJobAndRunRequest{
		ApiService: a,
		ctx: ctx,
		jobId: jobId,
 ...
 * @return Event
 */
func (a *EventApiService) CreateEventForJobAndRunExecute(r ApiCreateEventForJobAndRunRequest) (Event, *_nethttp.Response, error) {
	var (
...
func (r ApiCreateEventForWorkflowAndRunRequest) Execute() (Event, *_nethttp.Response, error) {
 ...
 */
func (a *EventApiService) CreateEventForWorkflowAndRun(ctx _context.Context, workflowId string, runId string) ApiCreateEventForWorkflowAndRunRequest {
	return ApiCreateEventForWorkflowAndRunRequest{
		ApiService: a,
		ctx: ctx,
 ...
 * @return Event
 */
func (a *EventApiService) CreateEventForWorkflowAndRunExecute(r ApiCreateEventForWorkflowAndRunRequest) (Event, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiFindEventsByJobIdAndRunIdRequest) Execute() ([]Event, *_nethttp.Response, error) {
 ...
 */
func (a *EventApiService) FindEventsByJobIdAndRunId(ctx _context.Context, jobId string, runId string) ApiFindEventsByJobIdAndRunIdRequest {
	return ApiFindEventsByJobIdAndRunIdRequest{
		ApiService: a,
		ctx: ctx,
		jobId: jobId,
 ...
 * @return []Event
 */
func (a *EventApiService) FindEventsByJobIdAndRunIdExecute(r ApiFindEventsByJobIdAndRunIdRequest) ([]Event, *_nethttp.Response, error) {
	var (
...
func (r ApiFindEventsByWorkflowIdAndRunIdRequest) Execute() ([]Event, *_nethttp.Response, error) {
 ...
 */
func (a *EventApiService) FindEventsByWorkflowIdAndRunId(ctx _context.Context, workflowId string, runId string) ApiFindEventsByWorkflowIdAndRunIdRequest {
	return ApiFindEventsByWorkflowIdAndRunIdRequest{
		ApiService: a,
		ctx: ctx,
		workflowId: workflowId,
 ...
 * @return []Event
 */
func (a *EventApiService) FindEventsByWorkflowIdAndRunIdExecute(r ApiFindEventsByWorkflowIdAndRunIdRequest) ([]Event, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
