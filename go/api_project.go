...
func (r ApiCreateJobForProjectRequest) Execute() (*Job, *http.Response, error) {
...
func (r ApiCreateWorkflowForProjectRequest) Execute() (*Workflow, *http.Response, error) {
...
func (r ApiDeleteProjectByIdRequest) Execute() (*http.Response, error) {
...
func (r ApiFindBannerByProjectIdRequest) XTenant(xTenant string) ApiFindBannerByProjectIdRequest {
	r.xTenant = &xTenant
	return r
}

// Size of the banner
func (r ApiFindBannerByProjectIdRequest) Size(size string) ApiFindBannerByProjectIdRequest {
	r.size = &size
	return r
}

func (r ApiFindBannerByProjectIdRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.FindBannerByProjectIdExecute(r)
}
...
func (a *ProjectAPIService) FindBannerByProjectIdExecute(r ApiFindBannerByProjectIdRequest) (*os.File, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectAPIService.FindBannerByProjectId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/projects/{projectId}/banner"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
func (r ApiFindJobsByProjectIdRequest) Type_(type_ string) ApiFindJobsByProjectIdRequest {
	r.type_ = &type_
	return r
}

func (r ApiFindJobsByProjectIdRequest) Execute() ([]Job, *http.Response, error) {
...
func (r ApiFindLatestRunsByProjectIdRequest) Execute() ([]RunWithJob, *http.Response, error) {
...
*/
func (a *ProjectAPIService) FindProjects(ctx context.Context) ApiFindProjectsRequest {
	return ApiFindProjectsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (r ApiFindWorkflowsByProjectIdRequest) Execute() ([]Workflow, *http.Response, error) {
...
func (r ApiGetMetricsForProjectRequest) Execute() ([]Metric, *http.Response, error) {
...
func (r ApiGetStatsByProjectIdRequest) Execute() (*RunStats, *http.Response, error) {
...
func (r ApiUploadBannerRequest) XTenant(xTenant string) ApiUploadBannerRequest {
	r.xTenant = &xTenant
	return r
}
...
func (r ApiUploadBannerRequest) Execute() (*http.Response, error) {
	return r.ApiService.UploadBannerExecute(r)
}
...
func (a *ProjectAPIService) UploadBannerExecute(r ApiUploadBannerRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectAPIService.UploadBanner")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
