...
// checks if the WriteTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WriteTask{}
...
type _WriteTask WriteTask

// NewWriteTask instantiates a new WriteTask object
...
func NewWriteTask(id string, params WriteTaskParameters, dependency []string) *WriteTask {
	...
	var type_ string = "write"
	this.Type = &type_
	return &this
}

// NewWriteTaskWithDefaults instantiates a new WriteTask object
...
func (o *WriteTask) UnmarshalJSON(bytes []byte) (err error) {
	...
	varWriteTask := _WriteTask{}

	err = json.Unmarshal(bytes, &varWriteTask)

	if err != nil {
		return err
	}

	*o = WriteTask(varWriteTask)
...
func NewNullableWriteTask(val *WriteTask) *NullableWriteTask {
	return &NullableWriteTask{value: val, isSet: true}
}
