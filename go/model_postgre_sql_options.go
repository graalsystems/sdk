...
// checks if the PostgreSQLOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgreSQLOptions{}
...
// NewPostgreSQLOptions instantiates a new PostgreSQLOptions object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostgreSQLOptions() *PostgreSQLOptions {
	this := PostgreSQLOptions{}
	var type_ string = "postgresql"
	this.Type = &type_
	return &this
}

// NewPostgreSQLOptionsWithDefaults instantiates a new PostgreSQLOptions object
...
func (v NullablePostgreSQLOptions) Get() *PostgreSQLOptions {
	return v.value
}

func (v *NullablePostgreSQLOptions) Set(val *PostgreSQLOptions) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePostgreSQLOptions(val *PostgreSQLOptions) *NullablePostgreSQLOptions {
	return &NullablePostgreSQLOptions{value: val, isSet: true}
}
