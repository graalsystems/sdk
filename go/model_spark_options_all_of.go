...
// NewSparkOptionsAllOf instantiates a new SparkOptionsAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSparkOptionsAllOf() *SparkOptionsAllOf {
	this := SparkOptionsAllOf{}
	var type_ string = "spark"
	this.Type = &type_
	return &this
}

// NewSparkOptionsAllOfWithDefaults instantiates a new SparkOptionsAllOf object
...
func (o *SparkOptionsAllOf) GetConf() map[string]interface{} {
	if o == nil || o.Conf == nil {
...
// and a boolean to check if the value has been set.
func (o *SparkOptionsAllOf) GetConfOk() (*map[string]interface{}, bool) {
	if o == nil || o.Conf == nil {
		return nil, false
	}
	return o.Conf, true
...
func (o *SparkOptionsAllOf) SetConf(v map[string]interface{}) {
	o.Conf = &v
}
...
type NullableSparkOptionsAllOf struct {
	value *SparkOptionsAllOf
	isSet bool
}

func (v NullableSparkOptionsAllOf) Get() *SparkOptionsAllOf {
	return v.value
}

func (v *NullableSparkOptionsAllOf) Set(val *SparkOptionsAllOf) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSparkOptionsAllOf(val *SparkOptionsAllOf) *NullableSparkOptionsAllOf {
	return &NullableSparkOptionsAllOf{value: val, isSet: true}
}
