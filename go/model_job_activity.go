...
// checks if the JobActivity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobActivity{}
...
type _JobActivity JobActivity

// NewJobActivity instantiates a new JobActivity object
...
// NewJobActivityWithDefaults instantiates a new JobActivity object
...
func (o *JobActivity) UnmarshalJSON(bytes []byte) (err error) {
	...
	varJobActivity := _JobActivity{}

	err = json.Unmarshal(bytes, &varJobActivity)

	if err != nil {
		return err
	}

	*o = JobActivity(varJobActivity)
...
func (v NullableJobActivity) Get() *JobActivity {
	return v.value
}
...
func NewNullableJobActivity(val *JobActivity) *NullableJobActivity {
	return &NullableJobActivity{value: val, isSet: true}
}
