...
// NewRayOptionsAllOf instantiates a new RayOptionsAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRayOptionsAllOf() *RayOptionsAllOf {
	this := RayOptionsAllOf{}
	var type_ string = "ray"
	this.Type = &type_
	return &this
}

// NewRayOptionsAllOfWithDefaults instantiates a new RayOptionsAllOf object
...
type NullableRayOptionsAllOf struct {
	value *RayOptionsAllOf
	isSet bool
}

func (v NullableRayOptionsAllOf) Get() *RayOptionsAllOf {
	return v.value
}

func (v *NullableRayOptionsAllOf) Set(val *RayOptionsAllOf) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRayOptionsAllOf(val *RayOptionsAllOf) *NullableRayOptionsAllOf {
	return &NullableRayOptionsAllOf{value: val, isSet: true}
}
