...
class Target(BaseModel):
    ...
    def _get_discriminator_value_class_map(cls) -> ClassVar[Dict[str, str]]:
        if cls.__discriminator_value_class_map == None:
            ...
            globals()["admin"] = importlib.import_module("graalsystems.models.admin").admin
            globals()["kubernetes"] = importlib.import_module("graalsystems.models.kubernetes").kubernetes
