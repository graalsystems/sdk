...
class Details1(BaseModel):
    ...
    def _get_discriminator_value_class_map(cls) -> ClassVar[Dict[str, str]]:
        if cls.__discriminator_value_class_map == None:
            ...
            globals()["credit_card"] = importlib.import_module("graalsystems.models.credit_card").credit_card
            globals()["in_person"] = importlib.import_module("graalsystems.models.in_person").in_person
            globals()["sepa"] = importlib.import_module("graalsystems.models.sepa").sepa
            globals()["trial"] = importlib.import_module("graalsystems.models.trial").trial
