...
class Uri(BaseModel):
    ...
    def _get_discriminator_value_class_map(cls) -> ClassVar[Dict[str, str]]:
        if cls.__discriminator_value_class_map == None:
            ...
            globals()["azure"] = importlib.import_module("graalsystems.models.azure").azure
            globals()["generic"] = importlib.import_module("graalsystems.models.generic").generic
            globals()["s3"] = importlib.import_module("graalsystems.models.s3").s3
