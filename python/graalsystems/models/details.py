...
class Details(BaseModel):
    ...
    def _get_discriminator_value_class_map(cls) -> ClassVar[Dict[str, str]]:
        if cls.__discriminator_value_class_map == None:
            ...
            globals()["issue"] = importlib.import_module("graalsystems.models.issue").issue
            globals()["quota"] = importlib.import_module("graalsystems.models.quota").quota
            globals()["subscription"] = importlib.import_module("graalsystems.models.subscription").subscription
