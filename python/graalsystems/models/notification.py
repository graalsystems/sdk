...
class Notification(BaseModel):
    ...
    def _get_discriminator_value_class_map(cls) -> ClassVar[Dict[str, str]]:
        if cls.__discriminator_value_class_map == None:
            ...
            globals()["ai"] = importlib.import_module("graalsystems.models.ai").ai
            globals()["eventhub"] = importlib.import_module("graalsystems.models.eventhub").eventhub
            globals()["mail"] = importlib.import_module("graalsystems.models.mail").mail
            globals()["webhook"] = importlib.import_module("graalsystems.models.webhook").webhook
