...
class AzureLogAnalyticsNotification(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'ai': AzureLogAnalyticsNotification,
            'eventhub': EventHubNotification,
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AzureLogAnalyticsNotification - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): [optional] if omitted the server will use the default value of "eventhub"  # noqa: E501
