...
class AndFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, conditions, *args, **kwargs):  # noqa: E501
        """AndFilter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Operator for AND filter.. [optional] if omitted the server will use the default value of "and"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, conditions, *args, **kwargs):  # noqa: E501
        """AndFilter - a model defined in OpenAPI
