...
class NotFilter(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'condition': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, condition, *args, **kwargs):  # noqa: E501
        """NotFilter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Operator for NOT filter.. [optional] if omitted the server will use the default value of "not"  # noqa: E501
        """
