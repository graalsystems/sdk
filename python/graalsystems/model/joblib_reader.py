...
class JoblibReader(ModelNormal):
    ...
    def _from_openapi_data(cls, path, *args, **kwargs):  # noqa: E501
        """JoblibReader - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Define file type for Joblib.. [optional] if omitted the server will use the default value of "joblib"  # noqa: E501
        """
