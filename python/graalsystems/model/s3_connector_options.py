...
class S3ConnectorOptions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bucket, access_key, secret_key, *args, **kwargs):  # noqa: E501
        """S3ConnectorOptions - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            session_token (str): S3 session token to access to AWS.. [optional]  # noqa: E501
            endpoint (str): The endpoint to be connected to.. [optional]  # noqa: E501
            region_name (str): The region of the endpoint.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, bucket, access_key, secret_key, *args, **kwargs):  # noqa: E501
        """S3ConnectorOptions - a model defined in OpenAPI
