...
class FilterTask(ModelNormal):
    ...
    def _from_openapi_data(cls, id, params, dependency, *args, **kwargs):  # noqa: E501
        """FilterTask - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type of the filter task.. [optional] if omitted the server will use the default value of "filter"  # noqa: E501
        """
