...
class JoinParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, columns, join_type, *args, **kwargs):  # noqa: E501
        """JoinParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, columns, join_type, *args, **kwargs):  # noqa: E501
        """JoinParams - a model defined in OpenAPI
