...
class MaxParams(ModelNormal):
    ...
    def _from_openapi_data(cls, columns, *args, **kwargs):  # noqa: E501
        """MaxParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Maximum aggregation.. [optional] if omitted the server will use the default value of "max"  # noqa: E501
        """
