...
class PickleReader(ModelNormal):
    ...
    def _from_openapi_data(cls, path, *args, **kwargs):  # noqa: E501
        """PickleReader - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Define file type for Pickle.. [optional] if omitted the server will use the default value of "pickle"  # noqa: E501
        """
