...
class IssueDetails(ModelComposed):
    ...
    allowed_values = {
        ('severity',): {
            'P1_MINIMAL': "p1_minimal",
            'P2_MODERATE': "p2_moderate",
            'P3_CRITICAL': "p3_critical",
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): [optional] if omitted the server will use the default value of "issue"  # noqa: E501
