...
def lazy_import():
    ...
    globals()['DockerOptionsAllOf'] = DockerOptionsAllOf
...
class DockerOptions(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DockerOptions - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): [optional] if omitted the server will use the default value of "docker"  # noqa: E501
            registry (str): [optional] if omitted the server will use the default value of "https://index.docker.io/v1/"  # noqa: E501
