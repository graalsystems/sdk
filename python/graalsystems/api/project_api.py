...
class ProjectApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_costs_by_project_id(
            self,
            x_tenant,
            project_id,
            **kwargs
        ):
            """Find the costs for a project  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_costs_by_project_id(x_tenant, project_id, async_req=True)
            >>> result = thread.get()

            Args:
                x_tenant (str):
                project_id (str): Id of the Job
        ...
        self.get_costs_by_project_id = _Endpoint(
            settings={
                'response_type': (CostStats,),
                'auth': [
                    'internal'
                ],
                'endpoint_path': '/projects/{projectId}/costs',
                'operation_id': 'get_costs_by_project_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_costs_by_project_id
        )
