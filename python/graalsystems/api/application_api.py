...
class ApplicationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __delete_application_by_id(
            self,
            x_tenant,
            application_id,
            **kwargs
        ...
        self.delete_application_by_id = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'internal'
            ...
            api_client=api_client,
            callable=__delete_application_by_id
        )

        def __find_application_by_id(
            self,
            x_tenant,
            application_id,
            **kwargs
        ...
        self.find_application_by_id = _Endpoint(
            settings={
                'response_type': (Application,),
                'auth': [
                    'internal'
            ...
            api_client=api_client,
            callable=__find_application_by_id
        )

        def __find_applications(
            self,
            x_tenant,
            **kwargs
        ):
        ...
        self.find_applications = _Endpoint(
            settings={
                'response_type': ([Application],),
                'auth': [
                    'internal'
