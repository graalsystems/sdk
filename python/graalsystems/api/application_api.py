...
class ApplicationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_application_by_remote_application_id_endpoint = _Endpoint(
            settings={
                'response_type': (Application,),
                'auth': [
                    'internal'
                ],
                'endpoint_path': '/remote/applications/{remote_application_id}',
                'operation_id': 'find_application_by_remote_application_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def find_application_by_remote_application_id(
        self,
        x_tenant,
        remote_application_id,
        **kwargs
    ):
        """Find application by remote application id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.find_application_by_remote_application_id(x_tenant, remote_application_id, async_req=True)
        >>> result = thread.get()

        Args:
            x_tenant (str):
            remote_application_id (str): Remote id of the application
        ...
        kwargs['x_tenant'] = \
            x_tenant
        kwargs['remote_application_id'] = \
            remote_application_id
        return self.find_application_by_remote_application_id_endpoint.call_with_http_info(**kwargs)
