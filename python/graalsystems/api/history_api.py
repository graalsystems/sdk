...
class HistoryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __add_resource_history_for_user(
            self,
            x_tenant,
            type,
            id,
        ...
        self.add_resource_history_for_user = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'internal'
            ...
            callable=__add_resource_history_for_user
        )

        def __add_search_history_for_user(
            self,
            x_tenant,
            search_history,
            **kwargs
        ...
        self.add_search_history_for_user = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__add_search_history_for_user
        )

        def __get_resource_history(
            self,
            x_tenant,
            **kwargs
        ):
        ...
        self.get_resource_history = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_resource_history
        )

        def __get_search_history(
            self,
            x_tenant,
            **kwargs
        ):
        ...
        self.get_search_history = _Endpoint(
            settings={
                'response_type': ([SearchHistory],),
                'auth': [
                    'internal'
