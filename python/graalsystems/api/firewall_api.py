...
class FirewallApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.check_access_by_ip = _Endpoint(
            settings={
            ...
            callable=__check_access_by_ip
        )

        def __delete_firewall_rule_by_id(
            self,
            x_tenant,
            rule_id,
            **kwargs
        ...
        self.delete_firewall_rule_by_id = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'internal'
            ...
            api_client=api_client,
            callable=__delete_firewall_rule_by_id
        )

        def __find_firewall_rule_by_firewall_rule_id(
            self,
            x_tenant,
            rule_id,
            **kwargs
        ...
        self.find_firewall_rule_by_firewall_rule_id = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__find_firewall_rule_by_firewall_rule_id
        )

        def __find_firewall_rules(
            self,
            x_tenant,
            **kwargs
        ):
        ...
        self.find_firewall_rules = _Endpoint(
            settings={
                'response_type': ([FirewallRule],),
                'auth': [
                    'internal'
            ...
            api_client=api_client,
            callable=__find_firewall_rules
        )

        def __update_firewall_rule(
            self,
            x_tenant,
            rule_id,
            patch,
        ...
        self.update_firewall_rule = _Endpoint(
            settings={
                'response_type': (FirewallRule,),
                'auth': [
                    'internal'
            ...
            api_client=api_client,
            callable=__update_firewall_rule
        )
