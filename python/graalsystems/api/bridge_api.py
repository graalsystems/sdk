...
class BridgeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_bridge = _Endpoint(
            ...
            callable=__create_bridge
        )

        def __delete_bridge_by_id(
            self,
            x_tenant,
            bridge_id,
            **kwargs
        ...
        self.delete_bridge_by_id = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'internal'
            ...
            api_client=api_client,
            callable=__delete_bridge_by_id
        )

        def __find_bridge_by_id(
            self,
            x_tenant,
            bridge_id,
            **kwargs
        ...
        self.find_bridge_by_id = _Endpoint(
            settings={
                'response_type': (Bridge,),
                'auth': [
                    'internal'
